...
<html>
    ...
    <body>
        ...
        <form:form action="/WebProject/registration/save" modelAttribute="registerBean" method="POST" class="form-group">
            <table style="margin: 0px auto" class="table-condensed">
                ...
                <tr>
                    <td>
                    <form:label path="userName" class="col-md-12">Username</form:label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                    <form:label path="password" class="col-md-12">Password</form:label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                    <form:label path="passwordVerification" class="col-md-12">Password Verification</form:label>
                    </td>
                    <td>
